...
export function chunkText(text: string, limit: number = DISCORD_MESSAGE_LIMIT): string[] {
...
/** Neutralize mass-ping tokens the model might emit in reply text. */
export function neutralizeMassPings(text: string): string {
